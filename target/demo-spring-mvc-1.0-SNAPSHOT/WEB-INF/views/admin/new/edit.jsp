                ...
                <div class="col-xs-12">
                    ...
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="file" placeholder="Nhập tên bài viết . . ." class="col-xs-10 col-sm-5" id="thumbnail" name="thumbnail" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <form:textarea path="shortDescription" cols="10" rows="5" cssClass="form-control" id="shortDescription"/>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $('#btnAddOrUpdateNew').click(function (e) {
        e.preventDefault(); // để submit vào đường dẫn url /api/new
        var data = {};
        var formData = $('#formSubmit').serializeArray(); //lấy dữ liệu từ các field trong các ô nhập vào
    ...
    function addNew(data) {
        $.ajax({
            ...
            error: function (error) {
                window.location.href = "${newURL}?page=1&limit=2&error_system";
            }
        });
    }
